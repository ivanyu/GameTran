...
def get_wordreference_dictionaries(
...
def wordreference_url(text: str, game_language: str, user_language: str) -> str:
    ...
    return (
        f"https://www.wordreference.com/{game_language}{user_language}/{text_encoded}"
    )
...
def wordreference_definition_url(text: str, game_language: str) -> str:
    text_encoded = quote(text)
    return (
        f"https://www.wordreference.com/{game_language}{game_language}/{text_encoded}"
    )
