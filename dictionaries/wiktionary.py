...
def get_wiktionary_dictionaries(
    game_language: str, user_language: str
) -> list[Dictionary]:
...
def wiktionary_game_language_url(text: str, game_language: str) -> str:
    ...
    language_name_in_language = _LANGUAGE_NAMES.get(game_language, {}).get(
        game_language
    )
...
def wiktionary_user_language_url(
    text: str, game_language: str, user_language: str
) -> str:
    text_encoded = quote(text)
    language_name_in_language = _LANGUAGE_NAMES.get(user_language, {}).get(
        game_language
    )
    anchor = f"#{language_name_in_language}"
