...
from dictionaries.wiktionary import (
    get_wiktionary_dictionaries,
    wiktionary_game_language_url,
    wiktionary_user_language_url,
)
from dictionaries.wordreference import (
    get_wordreference_dictionaries,
    wordreference_definition_url,
    wordreference_url,
)
...
def get_dictionaries(game_language: str, user_language: str) -> list[Dictionary]:
    ...
    if game_language == EN_LANG_CODE:
        result.append(
            Dictionary(
                id=DictionaryId.cambridge_dictionary, title="Cambridge Dictionary"
            )
        )
        result.append(
            Dictionary(
...
def get_dictionary_url(
    *, text: str, game_language: str, user_language: str, dictionary_id: DictionaryId
) -> Optional[str]:
    match dictionary_id:
