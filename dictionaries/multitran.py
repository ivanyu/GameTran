...
from dictionaries import EN_LANG_CODE, RU_LANG_CODE, FR_LANG_CODE
from dictionaries.types import Dictionary, DictionaryId
from dictionaries.languages import DE_LANG_CODE, ES_LANG_CODE, AR_LANG_CODE, PT_LANG_CODE, RO_LANG_CODE, PL_LANG_CODE, \
    BG_LANG_CODE, CS_LANG_CODE, IT_LANG_CODE, NL_LANG_CODE, JA_LANG_CODE, SV_LANG_CODE, TR_LANG_CODE, FI_LANG_CODE, \
    EL_LANG_CODE, KO_LANG_CODE, GA_LANG_CODE
