...
from process import focus_window, get_active_process, resume_process, suspend_process, Process
...
class Application(QApplication):
    ...
    def __init__(self, argv: list[str]) -> None:
        ...
        if sys.platform == "linux":
            self._overlay_window.got_focus.connect(self._on_overlay_window_focus_linux_only)
    ...
    def _on_systray_menu_about() -> None:
        ...
        about_text += (
            "<p style='font-size: small;'>" + "<br>".join(details) + "</p>"
        )
